    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          // extendBody: true makes the body render behind the glass nav bar.
          // We inject a bottom padding equal to the nav bar height (58px) plus
          // the OS gesture inset so content is never hidden behind the bar.
          // Each screen's own SafeArea / bottom SizedBox should NOT add extra
          // clearance on top of this — the MediaQuery already carries it.
          child: MediaQuery(

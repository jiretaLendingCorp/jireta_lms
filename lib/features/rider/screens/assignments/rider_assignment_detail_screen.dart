        ...
        data: (a) => SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              WhiteCard(
                child: Column(
                  ...
                  children: [
                    ...
                    _InfoRow(
                        'Address', a.lenderAddress ?? 'Not provided'),
                      ...
                      const Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 2),
                            Text(
                                'Visit the lender, verify info, and submit CI report.',
                                style: TextStyle(
                                    color: Color(0xFF92400E),
                                    fontSize: 12)),
                          ],
              ...
              if (a.isCreditInvestigation) const SizedBox(height: 14),
                ...
                WhiteCard(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (a.ciNotes != null &&
                          a.ciNotes!.isNotEmpty) ...[
                        const SizedBox(height: 10),
                        Text('Notes: ${a.ciNotes}',
                            style: const TextStyle(
              ...
              if (a.status == AssignmentStatus.inProgress) ...[
                if (a.isCreditInvestigation) ...[
                  AppButton(
                    ...
                    width: double.infinity,
                    onPressed: () =>
                        context.go('/rider/ci-upload/${a.id}'),
                  ),
                ] else ...[
                  AppButton(

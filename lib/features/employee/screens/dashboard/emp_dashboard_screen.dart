          ...
          KpiGrid(
            cards: [
              ...
              KpiCard(
                label: 'Cash Queue',
                value: paymentsAsync.when(
                  data: (p) => '${p.where((x) => x.method.value == 'cash').length}',
                  loading: () => '—',
                  error: (_, __) => '—',
                ),
                icon: AppIcons.truck,
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: const Icon(AppIcons.loans, size: 17, color: AppColors.warning),
                          ),
        ...
        data: (payments) {
          if (payments.isEmpty) {
            return const Padding(
              padding: EdgeInsets.all(32),
              child: Center(
                child: Text('No pending payments', style: TextStyle(fontSize: 14)),
              ),
            );
          }
          return Column(
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          height: 36,
                          decoration: BoxDecoration(
                            color: (isCash ? AppColors.success : AppColors.info).withOpacity(0.1),
                            borderRadius: BorderRadius.circular(8),
                          ),
                          child: Icon(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            StatusChip.paymentStatus(pmt.status.value, small: true),
                          ],
                        ),
                      ],
                    ),
